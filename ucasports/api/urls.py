...
from .views import SportAPIView, TeamAPIView, UserAPIView, CompetitorsAPIView, CompetitionAPIView, EventAPIView, CustomUserDetail, TeamDetail, TeamUpdate, EventPhotosAPIView
...
urlpatterns = [
    ...
    path('event/<int:event_id>/photos/', EventPhotosAPIView.as_view(), name='event-photos'),
